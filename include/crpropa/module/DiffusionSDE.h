...
public:
	...
	void tryStep(const Vector3d &Pos, Vector3d &POut, Vector3d &PosErr, double z, double t, double propStep) const;
	void driftStep(const Vector3d &Pos, Vector3d &LinProp, double h, double t) const;
	void calculateBTensor(double rig, double BTen[], Vector3d pos, Vector3d dir, double z, double t) const;
